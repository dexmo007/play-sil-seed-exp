...
class OAuth1InfoDAO @Inject() (@NamedDatabase("users") protected val dbConfigProvider: DatabaseConfigProvider, val loginInfoDAO: LoginInfoDAO)
  ...
  override protected val tableQuery = TableQuery[OAuth1InfoTable]
  ...
  class OAuth1InfoTable(tag: Tag) extends Table[DBOAuth1Info](tag, "oauth1_info") with IdWrappedTable {
